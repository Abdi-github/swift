...
ARG VITE_APP_I18NEXUS_KEY
ARG VITE_APP_EMAIL_PUBLIC_KEY
ARG VITE_APP_EMAIL_SERVICE_ID
ARG VITE_APP_EMAIL_TEMPLATE_ID

# Set them as environment variables so Vite can access them
ENV VITE_APP_I18NEXUS_KEY=$VITE_APP_I18NEXUS_KEY
ENV VITE_APP_EMAIL_PUBLIC_KEY=$VITE_APP_EMAIL_PUBLIC_KEY
ENV VITE_APP_EMAIL_SERVICE_ID=$VITE_APP_EMAIL_SERVICE_ID
ENV VITE_APP_EMAIL_TEMPLATE_ID=$VITE_APP_EMAIL_TEMPLATE_ID
# Build the React app
RUN npm run build
